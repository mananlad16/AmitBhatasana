...
jQuery(document).ready(function(){
	...
	var switcherHTML = '<div id="switcher">';
		...
		switcherHTML +=    		'<span class="fa fa-whatsapp"></span>';
		switcherHTML +=    		'<h4><a href="https://wa.link/scze8o">Whatsapp</a></h4>';
		switcherHTML +='</div>';
		switcherHTML +='</div>';
		...
		//switcher toggle
		jQuery('#switcher span[class="fa fa-whatsapp"]').on('click', function(){
